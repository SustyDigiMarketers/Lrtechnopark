      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            >
              <div className="w-10 h-10 rounded-2xl bg-slate-900 border border-slate-800 flex items-center justify-center text-white shadow-md group-hover:border-blue-500/50 transition-colors">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] font-mono tracking-widest text-slate-500 uppercase leading-tight mt-1">
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-sm font-normal">
              Enterprise computer hardware, high-throughput networking, next-gen firewalls, and CCTV surveillance systems built for modern business operations.
            </p>
