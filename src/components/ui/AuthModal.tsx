      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
          ...
          <motion.div
            ...
            className="relative w-full max-w-md rounded-3xl bg-white border border-slate-200/90 shadow-2xl overflow-hidden z-10 my-8 text-slate-800"
          >
            {/* Header */}
            <div className="flex items-center justify-between px-7 py-5 border-b border-slate-100 bg-[#fafbff]">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-blue-50 border border-blue-100 flex items-center justify-center text-[#1a56db]">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">Identity & License Management</p>
                </div>
              </div>
              <button
                type="button"
            ...
            <div className="p-7 space-y-5">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-1.5 pt-1">
                    {(['customer', 'sales', 'support', 'admin', 'superadmin'] as UserRole[]).map((role) => (
                      <button
                        ...
                        className="py-2 px-2.5 rounded-xl bg-white hover:bg-amber-100/60 border border-amber-200 text-left transition-colors cursor-pointer group shadow-2xs"
                      >
                        <div className="text-xs font-bold text-slate-900 capitalize group-hover:text-[#1a56db]">
                          {role}
                        </div>
              ...
              {mode !== 'forgot' && (
                <button
                  ...
                  className="w-full py-3 px-4 rounded-full bg-slate-50 hover:bg-slate-100 text-slate-700 text-xs font-bold border border-slate-200 flex items-center justify-center gap-2.5 transition-all cursor-pointer shadow-2xs hover:border-slate-300 active:scale-98"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-10 pr-3.5 py-2.5 text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-[#1a56db] focus:bg-white"
                        />
                      </div>
                    </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-10 pr-3.5 py-2.5 text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-[#1a56db] focus:bg-white font-normal"
                    />
                  </div>
                </div>
                    ...
                    <div className="flex items-center justify-between mb-1">
                      ...
                      {mode === 'login' && (
                        <button
                          ...
                          className="text-[11px] text-[#1a56db] hover:underline cursor-pointer font-bold"
                        >
                          Forgot?
                        </button>
                      )}
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full py-3.5 rounded-full bg-[#1a56db] hover:bg-[#1545b3] disabled:opacity-50 text-white text-xs font-bold flex items-center justify-center gap-2 transition-all cursor-pointer shadow-md shadow-blue-600/20 mt-2 active:scale-98"
                >
                  {isLoading ? (
                ...
                {mode === 'login' && (
                  <p>
                    ...
                    <button
                      ...
                      className="text-[#1a56db] font-bold hover:underline cursor-pointer"
                    >
                      Register here
                    </button>
                  </p>
