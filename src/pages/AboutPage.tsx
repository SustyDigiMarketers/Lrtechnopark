    ...
    <PageTransition className="pt-32 pb-24 bg-[#fafbff] min-h-screen text-slate-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          {/* Who We Are (5 cols) */}
          <div className="lg:col-span-5 p-8 sm:p-10 rounded-3xl bg-white border border-slate-200/90 shadow-xs space-y-4">
            ...
            <div className="pt-2">
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#1a56db] hover:bg-[#1545b3] text-white text-xs font-bold transition-all cursor-pointer shadow-md shadow-blue-600/20"
              >
          ...
          <div className="lg:col-span-7 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-6 rounded-2xl bg-white border border-slate-200/90 shadow-xs space-y-2 hover:border-blue-300 transition-colors">
                <div className="w-10 h-10 rounded-xl bg-blue-50 text-[#1a56db] flex items-center justify-center">
                  <Cpu className="w-5 h-5" />
                </div>
                <h3 className="text-base font-bold text-slate-900">Computer Hardware</h3>
              ...
              <div className="p-6 rounded-2xl bg-white border border-slate-200/90 shadow-xs space-y-2 hover:border-blue-300 transition-colors">
                ...
                <h3 className="text-base font-bold text-slate-900">Networking</h3>
                <p className="text-xs text-slate-600 leading-relaxed">
              ...
              <div className="p-6 rounded-2xl bg-white border border-slate-200/90 shadow-xs space-y-2 hover:border-blue-300 transition-colors">
                ...
                <h3 className="text-base font-bold text-slate-900">CCTV Cameras</h3>
                <p className="text-xs text-slate-600 leading-relaxed">
              ...
              <div className="p-6 rounded-2xl bg-white border border-slate-200/90 shadow-xs space-y-2 hover:border-blue-300 transition-colors">
                ...
                <h3 className="text-base font-bold text-slate-900">WiFi & Firewalls</h3>
                <p className="text-xs text-slate-600 leading-relaxed">
        ...
        <div className="p-8 sm:p-12 rounded-3xl bg-white border border-slate-200/90 shadow-xs space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-2.5">
              <div className="text-lg font-bold font-mono text-[#1a56db]">01</div>
              <h3 className="text-base font-bold text-slate-900">Reliable Infrastructure</h3>
              <p className="text-xs text-slate-600 leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-2.5">
              <div className="text-lg font-bold font-mono text-[#1a56db]">02</div>
              <h3 className="text-base font-bold text-slate-900">Practical Solutions</h3>
              <p className="text-xs text-slate-600 leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-2.5">
              <div className="text-lg font-bold font-mono text-[#1a56db]">03</div>
              <h3 className="text-base font-bold text-slate-900">Fast Support</h3>
              <p className="text-xs text-slate-600 leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-2.5">
              <div className="text-lg font-bold font-mono text-[#1a56db]">04</div>
              <h3 className="text-base font-bold text-slate-900">Scalable Technology</h3>
              <p className="text-xs text-slate-600 leading-relaxed">
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-slate-500">Industry engineers with decades of hands-on deployment experience.</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {leadershipTeam.map((leader, i) => (
              <div
                key={i}
                className="p-6 rounded-3xl bg-white border border-slate-200/90 shadow-xs flex flex-col justify-between space-y-3"
              >
                <div className="space-y-2">
                  <div className="w-12 h-12 rounded-2xl bg-slate-950 text-blue-400 flex items-center justify-center font-bold text-sm font-mono">
                    {leader.name
                      .split(' ')
                      .map((n) => n[0])
                      .join('')}
                  ...
                  <div>
                    ...
                    <div className="text-xs font-semibold text-[#1a56db]">{leader.role}</div>
                  </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-left">
            {companyCertifications.map((cert, idx) => (
              ...
              >
                ...
                <div className="text-[10px] text-slate-500 font-mono">{cert.issuer} &bull; {cert.status}</div>
              </div>
            ))}
          </div>
        </div>
