    ...
    <PageTransition className="pt-32 pb-24 bg-[#07090e] min-h-screen text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          {/* Who We Are (5 cols) */}
          <div className="lg:col-span-5 p-8 sm:p-10 rounded-3xl bg-[#0d1322] border border-slate-800 shadow-xl space-y-4">
            ...
            <div className="pt-2">
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-300 hover:to-amber-400 text-slate-950 text-xs font-bold transition-all cursor-pointer shadow-md shadow-amber-500/20 active:scale-98"
              >
          ...
          <div className="lg:col-span-7 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs text-slate-400 font-mono">4 Core Domains</span>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-6 rounded-2xl bg-[#0d1322] border border-slate-800 shadow-xl space-y-2 hover:border-amber-500/50 transition-colors">
                ...
                <h3 className="text-base font-bold text-white">Computer Hardware</h3>
              ...
              <div className="p-6 rounded-2xl bg-[#0d1322] border border-slate-800 shadow-xl space-y-2 hover:border-amber-500/50 transition-colors">
                ...
                <h3 className="text-base font-bold text-white">Networking</h3>
                <p className="text-xs text-slate-400 leading-relaxed">
              ...
              <div className="p-6 rounded-2xl bg-[#0d1322] border border-slate-800 shadow-xl space-y-2 hover:border-amber-500/50 transition-colors">
                ...
                <h3 className="text-base font-bold text-white">CCTV Cameras</h3>
                <p className="text-xs text-slate-400 leading-relaxed">
              ...
              <div className="p-6 rounded-2xl bg-[#0d1322] border border-slate-800 shadow-xl space-y-2 hover:border-amber-500/50 transition-colors">
                ...
                <h3 className="text-base font-bold text-white">WiFi & Firewalls</h3>
                <p className="text-xs text-slate-400 leading-relaxed">
        ...
        <div className="p-8 sm:p-12 rounded-3xl bg-[#0d1322] border border-slate-800 shadow-xl space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-6 rounded-2xl bg-slate-900/80 border border-slate-800 space-y-2.5 hover:border-amber-500/40 transition-colors">
              <div className="text-lg font-bold font-mono text-amber-400">01</div>
              <h3 className="text-base font-bold text-white">Reliable Infrastructure</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-slate-900/80 border border-slate-800 space-y-2.5 hover:border-amber-500/40 transition-colors">
              <div className="text-lg font-bold font-mono text-amber-400">02</div>
            ...
            <div className="p-6 rounded-2xl bg-slate-900/80 border border-slate-800 space-y-2.5 hover:border-amber-500/40 transition-colors">
              <div className="text-lg font-bold font-mono text-amber-400">03</div>
              <h3 className="text-base font-bold text-white">Fast Support</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-slate-900/80 border border-slate-800 space-y-2.5 hover:border-amber-500/40 transition-colors">
              <div className="text-lg font-bold font-mono text-amber-400">04</div>
              <h3 className="text-base font-bold text-white">Scalable Technology</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-slate-400">Industry engineers with decades of hands-on deployment experience.</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {leadershipTeam.map((leader, i) => (
              <div
                key={i}
                className="p-6 rounded-3xl bg-[#0d1322] border border-slate-800 shadow-xl flex flex-col justify-between space-y-3 hover:border-amber-500/40 transition-colors"
              >
                <div className="space-y-2">
                  <div className="w-12 h-12 rounded-2xl bg-slate-950 border border-amber-400/30 text-amber-400 flex items-center justify-center font-bold text-sm font-mono">
                    {leader.name
                      .split(' ')
                      .map((n) => n[0])
                      .join('')}
                  ...
                  <div>
                    ...
                    <div className="text-xs font-semibold text-amber-400">{leader.role}</div>
                  </div>
                  <p className="text-xs text-slate-400 leading-relaxed pt-1">{leader.bio}</p>
                </div>
        ...
        <div className="p-8 rounded-3xl bg-[#0d1322] border border-slate-800 shadow-xl">
